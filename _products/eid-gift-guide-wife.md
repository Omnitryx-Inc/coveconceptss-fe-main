---
layout: product
title: "Eid Gift Guide for Her"
description: "A beautiful curation of 50+ Eid gift ideas for the women in your life: sister, mother, wife, best friend."
price: 9.99
type: Digital
...
short_desc: "She deserves something special. This PDF guide gives you 50+ beautifully curated Eid gift ideas for the women you love, organized by relationship and budget."
---
    ...
    <div class="product-detail-grid">
      ...
      <div class="product-info">
        ...
        <div class="product-perks">
          <div class="perk"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg> Instant PDF download</div>
          <div class="perk"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg> 50+ gift ideas</div>
          <div class="perk"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg> For any budget</div>
          <div class="perk"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg> Beautifully designed</div>
        </div>
        <div class="accordion">
          <div class="accordion-item">
            ...
            <div class="accordion-body"><div class="accordion-body-inner">
              <p>The <strong>Eid Gift Guide for Her</strong> takes the guesswork out of gift-giving. Inside you'll find 50+ ideas organized by recipient (wife, mother, sister, friend) and budget, from small tokens to lavish surprises.</p>
              <p>Think: skincare, home decor, jewelry, experiences, books, and more. All selected with the modern Muslim woman in mind.</p>
            </div></div>
          </div>
          <div class="accordion-item">
            <button class="accordion-trigger" onclick="toggleAccordion(this)">Shipping & Delivery <span class="accordion-icon">+</span></button>
            <div class="accordion-body"><div class="accordion-body-inner">
              <p>This is a <strong>digital product</strong>. You will receive a download link by email immediately after purchase. No shipping required.</p>
            </div></div>
          </div>
          <div class="accordion-item">
            <button class="accordion-trigger" onclick="toggleAccordion(this)">Returns & Exchanges <span class="accordion-icon">+</span></button>
            <div class="accordion-body"><div class="accordion-body-inner">
              <p>All digital sales are final once the file has been accessed. See our <a href="/pages/exchange-policy.html">Exchange Policy</a>.</p>
            </div></div>
          </div>
        </div>
      </div>
...
<script>
  ...
  function addProductToCart() {
    ...
    addToCart('eid-wife', '{{ page.title }}', {{ page.price }}, '{{ page.images[0] }}', '{{ page.type }}', qty);
  }
