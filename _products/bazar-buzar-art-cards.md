---
layout: product
title: "Bazar Buzar Art Cards"
description: "Original hand-illustrated art cards celebrating South Asian market culture. Designed by Maryam Hua."
price: 6.00
type: Stationery
...
short_desc: "Original hand-illustrated art cards inspired by the sights and flavours of the South Asian bazaar. A beautiful keepsake or gift."
---
    ...
    <div class="product-detail-grid">
      ...
      <div class="product-info">
        ...
        <div class="product-perks">
          <div class="perk"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg> Hand-illustrated original art</div>
          <div class="perk"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg> Kraft paper wrap</div>
          <div class="perk"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg> Frame-worthy quality</div>
        ...
        <div class="accordion">
          <div class="accordion-item">
            ...
            <div class="accordion-body"><div class="accordion-body-inner">
              <p>These original hand-illustrated art cards celebrate the vibrant energy of the South Asian bazaar. Each card features bold, colourful artwork inspired by the markets, flavours, and ingredients of South Asia.</p>
              <p>Beautiful enough to frame, meaningful enough to send. Comes wrapped in kraft paper with a paper band.</p>
            </div></div>
          </div>
          <div class="accordion-item">
...
<script>
  ...
  function addProductToCart() {
    ...
    addToCart('art-cards', '{{ page.title }}', {{ page.price }}, '{{ page.images[0] }}', '{{ page.type }}', qty);
  }
